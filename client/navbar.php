<nav>
	...
	<?php
	$target_radio = $_GET['target_radio'];
	?>
	<ul class="mainMenu">
		<div class="nav_radios">
			<li>
				<input type="radio" name="nav_radios" id="noticias">
				<label for="noticias" id="l_noticas"><a href="#?target_radio=1">Noticias</a></label>
			</li>
			<li>
				<input type="radio" name="nav_radios" id="productos">
				<label for="productos" id="l_productos"><a href="front.php?target_radio=2">Productos</a></label>
			</li>
			<li>
				<input type="radio" name="nav_radios" id="modulos">
				<label for="modulos" id="l_modulos"><a href="#?target_radio=3">Modulos</a></label>
			</li>
			<li>
				<input type="radio" name="nav_radios" id="administrar">
				<label for="administrar" id="l_administrar"><a href="admin.php?target_radio=4">Administrar</a></label>
			</li>
			<li>
				<input type="radio" name="nav_radios" id="contactos">
				<label for="contactos" id="l_contactos"><a href="#?target_radio=5">Contactos</a></label>
			</li>
			<li>
				<input type="radio" name="nav_radios" id="sobre_nosotros">
				<label for="sobre_nosotros" id="l_sobre_nosotros"><a href="#?target_radio=6">Sobre nosotros</a></label>
			</li>
		</div>
